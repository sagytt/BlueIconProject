@extends('layouts.app')
@section('content')
<div class="card card-supplier mt-4 text-white mb-3 " style="max-width: 30rem;background: #252525">
    <div class="card-header">
        ...
        Apply To Be A Supplier</div>
    <div class="card-body">
        <form method="POST" id="supplierForm" action="{{route('supplier.request.save')}}">
            @csrf
            <div class="form-group">
                ...
                <input id="nameLoginInput" type="text"
                       ...
                       value="" placeholder="Enter your name" required autocomplete="name">
